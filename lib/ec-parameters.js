...
jCastle.pki.ecdsa.getCurveNameByParams = function(params)
{
	...
	var gx = new BigInteger(params.gx, 16);
	var gy = new BigInteger(params.gy, 16);
	...
	for (var i in jCastle.pki.ecdsa._registeredParams) {
		...
		if (new BigInteger(v_params.p, 16).equals(p) &&
			new BigInteger(v_params.a, 16).equals(a) &&
			new BigInteger(v_params.b, 16).equals(b) &&
			new BigInteger(v_params.gx, 16).equals(gx) &&
			new BigInteger(v_params.gy, 16).equals(gy) &&
			new BigInteger(v_params.n, 16).equals(n) &&
			v_params.h == params.h
		) {
			return i;
		}
...
jCastle.pki.ecdsa.getParametersObject = function(name)
{
	...
	var gx = new jCastle.ec.fieldElement.fp(curve.q, new BigInteger(params.gx, 16));
	var gy = new jCastle.ec.fieldElement.fp(curve.q, new BigInteger(params.gy, 16));
