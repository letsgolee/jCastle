/**
 * A Javascript implemenation of CRC32
 * 
 * @author Jacob Lee
 * 
...
jCastle.algorithm.crc32 = class
{
	...
	init(options = {})
	{
		this._state = 'initialValue' in options ? ~options.initialValue : ~0;
/*
		if (typeof jCastle.algorithm.crc32._crcTable == 'undefined') {

			jCastle.algorithm.crc32._crcTable = [];
			...
			for (var i = 0; i < 256; i++) {
				...
				jCastle.algorithm.crc32._crcTable[i] = rem;
			}
		}
*/
	}
	...
	process(input)
	{
		// always one byte block...
		this._state = (this._state >>> 8) ^ jCastle.algorithm.crc32._crcTable[(this._state & 255) ^ input[0]];
	}
	...
	finish()
	{
		...
		output.writeInt32BE(~this._state, 0, true);
...
jCastle.algorithm.CRC32 = jCastle.algorithm.crc32;

jCastle._algorithmInfo['crc32'] = {
	algorithm_type: 'hash',
	object_name: 'crc32',
	block_size: 1,
	digest_size: 4,
...
module.exports = jCastle.algorithm.crc32;