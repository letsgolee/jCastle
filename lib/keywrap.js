...
/**
 * creates a new class instance and wrap the keydata.
 * 
 * @public
 * @param {buffer | string} keydata key data.
 * @param {object} options options object.
 * @returns the wrapped key data.
 */
jCastle.keywrap.wrap = function(keydata, options)
{
    return new jCastle.keywrap().wrap(keydata, options);
};

/**
 * creates a new class instance and unwrap the keydata.
 * 
 * @public
 * @param {buffer | string} keydata key data.
 * @param {object} options options object.
 * @returns the unwrapped key data.
 */
jCastle.keywrap.unwrap = function(keydata, options)
{
    return new jCastle.keywrap().unwrap(keydata, options);
};
