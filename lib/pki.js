					...
					items: [{
						...
						value: {
							...
							items: [{
								...
								type: jCastle.asn1.tagOctetString,
								value: privkey.toBufferUnsigned().toString('latin1') // important!
							}, {
...
/*
				var der = asn1.getDER({
					...
					items: [{
						...
						type: jCastle.asn1.tagOctetString,
						value: privkey.toBufferUnsigned().toString('latin1')
					}, {
						tagClass: jCastle.asn1.tagClassContextSpecific,
						type: 0x00,
						constructed: true,
...
jCastle.pki.createPublicKeyIdentifier = function(pki)
{
	...
	// the created der string should be buffer string for safty reasons!
	switch (pki.pkiName) {
		case 'RSA':
			...
			der = new jCastle.asn1().getBuffer(schema);
			break;
		case 'DSA':
		case 'KCDSA':
			schema = {
...
// jCastle.pki.typePublicKey = 0x01;
// jCastle.pki.typePrivateKey = 0x02;
