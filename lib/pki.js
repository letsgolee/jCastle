...
*/
				if (sequence.items[0].items[1].type == jCastle.asn1.tagOID) {
					var params = jCastle.pki.ecdsa.getParametersByOID(sequence.items[0].items[1].value);
					if (!params) {
...
*/
					var params = jCastle.pki.ecdsa.getParametersByOID(sequence.items[1].items[1].value);
					if (!params) {
...
SEQUENCE(4 elem)
	...
	[1](1 elem)
		BIT STRING(520 bit) 				0000010001001110000100111110100111111111000110000000010010100010111111…
*/
					var params = jCastle.pki.ecdsa.getParametersByOID(sequence.items[2].items[0].value);
	...
	exportParameters(options = {})
	{
		...
		switch (this.pkiName) {
			...
			*/
				...
				var der = new jCastle.asn1().getDER({
					type: jCastle.asn1.tagSequence,
					items: [{
						type: jCastle.asn1.tagInteger,
						intVal: 0x01
