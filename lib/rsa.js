	...
	getPublicKey(format = 'object')
	{
		if (this.hasPubKey) {
			...
			switch (format.toLowerCase()) {
				...
				default:
					return {
						n: jCastle.util.formatBigInteger(this.publicKey.n),
						e: jCastle.util.formatBigInteger(BigInteger(this.publicKey.e.toString(16), 16))
					};
			...
			switch (format.toLowerCase()) {
				...
				default:
					return {
						n: jCastle.util.formatBigInteger(this.publicKey.n),
						e: jCastle.util.formatBigInteger(BigInteger(this.publicKey.e.toString(16), 16)),
						d: jCastle.util.formatBigInteger(this.privateKey.d),
						p: jCastle.util.formatBigInteger(this.privateKey.p),
						q: jCastle.util.formatBigInteger(this.privateKey.q),
						dmp1: jCastle.util.formatBigInteger(this.privateKey.dmp1),
						dmq1: jCastle.util.formatBigInteger(this.privateKey.dmq1),
						iqmp: jCastle.util.formatBigInteger(this.privateKey.iqmp)
					};
			}
		}
